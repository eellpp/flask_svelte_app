...
var app = (function () {
    ...
    function create_each_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			th = element("th");
    			t = text(t_value);
    			add_location(th, file$4, 33, 8, 658);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			td = element("td");
    			t = text(t_value);
    			add_location(td, file$4, 42, 9, 809);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_2$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$4, 40, 8, 752);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			ul = element("ul");
    			t = text(t_value);
    			add_location(ul, file$4, 64, 12, 1350);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$4, 53, 8, 930);
    			attr_dev(input, "class", "input");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Words to search");
    			add_location(input, file$4, 56, 16, 1059);
    			attr_dev(div0, "class", "control");
    			add_location(div0, file$4, 55, 12, 1021);
    			attr_dev(button, "class", "button is-link");
    			add_location(button, file$4, 59, 16, 1192);
    			attr_dev(div1, "class", "control");
    			add_location(div1, file$4, 58, 12, 1154);
    			attr_dev(div2, "class", "field is-grouped");
    			add_location(div2, file$4, 54, 8, 978);
    			attr_dev(ol, "type", "1");
    			add_location(ol, file$4, 62, 8, 1281);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 20, 0, 321);
    			add_location(button0, file$4, 21, 0, 353);
    			add_location(button1, file$4, 22, 0, 437);
    			attr_dev(section0, "class", "section");
    			add_location(section0, file$4, 19, 0, 295);
    			add_location(tr, file$4, 31, 4, 606);
    			add_location(thead, file$4, 30, 2, 594);
    			add_location(tbody0, file$4, 38, 2, 710);
    			add_location(tbody1, file$4, 48, 2, 865);
    			attr_dev(table_1, "class", "table");
    			add_location(table_1, file$4, 29, 0, 570);
    			attr_dev(div, "class", "content");
    			add_location(div, file$4, 26, 0, 546);
    			attr_dev(section1, "class", "section");
    			add_location(section1, file$4, 25, 0, 520);
    		},
    		l: function claim(nodes) {
    ...
    class Home extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { books: 1, table: 0 });
    ...
    const file$3 = "src/routes/Dataset.svelte";
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			th = element("th");
    			t = text(t_value);
    			add_location(th, file$3, 48, 8, 1170);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, th, anchor);
    			append_dev(th, t);
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			td = element("td");
    			t = text(t_value);
    			add_location(td, file$3, 57, 9, 1321);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, td, anchor);
    			append_dev(td, t);
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(tr, file$3, 55, 8, 1264);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, tr, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 37, 0, 899);
    			attr_dev(i, "id", "refreshicon");
    			attr_dev(i, "class", "fas fa-sync-alt");
    			add_location(i, file$3, 40, 8, 1015);
    			attr_dev(span, "class", "icon");
    			add_location(span, file$3, 39, 4, 987);
    			attr_dev(a, "class", "button is-small");
    			add_location(a, file$3, 38, 0, 936);
    			add_location(tr, file$3, 46, 4, 1118);
    			add_location(thead, file$3, 45, 2, 1106);
    			add_location(tbody0, file$3, 53, 2, 1222);
    			add_location(tbody1, file$3, 63, 2, 1377);
    			attr_dev(table_1, "class", "table");
    			add_location(table_1, file$3, 43, 0, 1081);
    			attr_dev(section, "class", "section");
    			attr_dev(section, "id", "table");
    			add_location(section, file$3, 36, 0, 862);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Dataset extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { table: 0 });
    ...
    const file$2 = "src/routes/Lorem.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$2, 17, 4, 410);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			add_location(h1, file$2, 14, 0, 271);
    			add_location(code, file$2, 15, 60, 352);
    			add_location(p, file$2, 15, 0, 292);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t18 = space();
    			a9 = element("a");
    			a9.textContent = "Report an issue";
    			t20 = space();
    			div6 = element("div");
    			div5 = element("div");
    			div4 = element("div");
    			...
    			add_location(main, file, 70, 0, 1706);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
