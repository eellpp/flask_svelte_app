...
var app = (function () {
    ...
    // (32:8) {#each book.SENTENCES as sentence}
    function create_each_block_1(ctx) {
    	let ul;
    	let t_value = /*sentence*/ ctx[6] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			ul = element("ul");
    			t = text(t_value);
    			add_location(ul, file$3, 32, 12, 820);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*books*/ 1 && t_value !== (t_value = /*sentence*/ ctx[6] + "")) set_data_dev(t, t_value);
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(32:8) {#each book.SENTENCES as sentence}",
    		ctx
    	});
    ...
    // (21:4) {#each books as book}
    function create_each_block$1(ctx) {
    	let h3;
    	let t0_value = /*book*/ ctx[3].NAME + "";
    	let t0;
    	let t1;
    	let div2;
    	let div0;
    	...
    	let ol;
    	let t5;
    	let each_value_1 = /*book*/ ctx[3].SENTENCES;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h3, file$3, 21, 8, 400);
    			attr_dev(input, "class", "input");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Words to search");
    			add_location(input, file$3, 24, 16, 529);
    			attr_dev(div0, "class", "control");
    			add_location(div0, file$3, 23, 12, 491);
    			attr_dev(button, "class", "button is-link");
    			add_location(button, file$3, 27, 16, 662);
    			attr_dev(div1, "class", "control");
    			add_location(div1, file$3, 26, 12, 624);
    			attr_dev(div2, "class", "field is-grouped");
    			add_location(div2, file$3, 22, 8, 448);
    			attr_dev(ol, "type", "1");
    			add_location(ol, file$3, 30, 8, 751);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*books*/ 1 && t0_value !== (t0_value = /*book*/ ctx[3].NAME + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*books*/ 1) {
    				each_value_1 = /*book*/ ctx[3].SENTENCES;
    				validate_each_argument(each_value_1);
    				let i;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(21:4) {#each books as book}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			button = element("button");
    			button.textContent = "Get a random number generated from flask server";
    			t5 = space();
    			...
    			add_location(h1, file$3, 11, 0, 187);
    			add_location(button, file$3, 12, 0, 219);
    			attr_dev(section0, "class", "section");
    			add_location(section0, file$3, 10, 0, 161);
    			attr_dev(div, "class", "content");
    			add_location(div, file$3, 16, 0, 341);
    			attr_dev(section1, "class", "section");
    			add_location(section1, file$3, 15, 0, 315);
    		},
    		l: function claim(nodes) {
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", /*getRand*/ ctx[2], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*rand*/ 2) set_data_dev(t1, /*rand*/ ctx[1]);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function getRand() {
    		fetch("./rand").then(d => d.text()).then(d => $$invalidate(1, rand = d));
    	}
    	...
    	$$self.$capture_state = () => ({ books, rand, getRand });
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a3, "href", "#/lorem/2");
    			add_location(a3, file, 26, 6, 741);
    			attr_dev(a4, "class", "navbar-link");
    			add_location(a4, file, 31, 8, 874);
    			attr_dev(a5, "class", "navbar-item");
    			add_location(a5, file, 36, 10, 975);
    			attr_dev(a6, "class", "navbar-item");
    			add_location(a6, file, 39, 10, 1042);
    			attr_dev(a7, "class", "navbar-item");
    			add_location(a7, file, 42, 10, 1108);
    			attr_dev(hr, "class", "navbar-divider");
    			add_location(hr, file, 45, 10, 1177);
    			attr_dev(a8, "class", "navbar-item");
    			add_location(a8, file, 46, 10, 1215);
    			attr_dev(div1, "class", "navbar-dropdown");
    			add_location(div1, file, 35, 8, 935);
    			attr_dev(div2, "class", "navbar-item has-dropdown is-hoverable");
    			add_location(div2, file, 30, 6, 814);
    			attr_dev(div3, "class", "navbar-start");
    			add_location(div3, file, 21, 4, 644);
    			add_location(strong, file, 57, 12, 1465);
    			attr_dev(a9, "class", "button is-primary");
    			add_location(a9, file, 56, 10, 1423);
    			attr_dev(a10, "class", "button is-light");
    			add_location(a10, file, 59, 10, 1515);
    			attr_dev(div4, "class", "buttons");
    			add_location(div4, file, 55, 8, 1391);
    			attr_dev(div5, "class", "navbar-item");
    			add_location(div5, file, 54, 6, 1357);
    			attr_dev(div6, "class", "navbar-end");
    			add_location(div6, file, 53, 4, 1326);
    			...
    			add_location(main, file, 68, 0, 1633);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
